...
def setup_handlers(self):
    conv_handler = ConversationHandler(
        ...
        states={
            MAIN_MENU: [
                ...
                CallbackQueryHandler(self.switch_account_menu, pattern="^switch_account$"),
            ...
            MANAGE_CONTACTS: [
                ...
                CallbackQueryHandler(self.clear_db_handler, pattern="^clear_db$"),
            ...
            EXTERNAL_INPUT_LINKS: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, self.process_external_links),
                CallbackQueryHandler(self.external_settings_handler, pattern="^cancel$")
            ],
            EXTERNAL_BROADCAST_CONFIRM: [
                CallbackQueryHandler(self.external_broadcast_handler, pattern="^external_broadcast$"),
    ...
    self.ptb_app.add_handler(CallbackQueryHandler(self.switch_account, pattern="^switch_account:.*$"))
    self.ptb_app.add_error_handler(self.error_handler)
    self.ptb_app.add_handler(
        MessageHandler(filters.Chat(GROUP_ID) & filters.StatusUpdate.NEW_CHAT_MEMBERS, self.on_new_member))